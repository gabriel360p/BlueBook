    ...
    <div class="card user-card-full">
        <div class="row m-l-0 m-r-0">
            ...
            <div class="col-sm-8">
                ...
                <div class="row">
                    <form action="/defeditPassword/{{$user->id}}" class="form-group" method="POST">
                    @csrf
                    <h6 class="m-b-20 m-t-40 p-b-5 b-b-default f-w-600">Alterar Senha</h6>
                    <div class="row">
                        <div class="col-sm-6">
                    ...
                    <div class="row">
                        <div class="container-fluid button-group">
                            ...
                            <a class="btn btn-outline-primary text-center small" href="/confirmedEmail">Esqueceu a senha?</a>
                        </form>
                        </div>
                    </div>
                </div>
