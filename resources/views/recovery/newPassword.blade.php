      ...
      <div class="col-lg-10 col-xl-9 mx-auto">
        <div class="card flex-row my-5 border-0 shadow rounded-3 overflow-hidden">
          ...
          <div class="card-body p-4 p-sm-5">
            <h5 class="card-title text-center mb-5 fw-light fs-5">Redefinição de Senha</h5>
            <!-- <div class="card-subtitle">Anote a senha :)</div> -->
              <hr>
            <form class="form-group" method="POST" action="/defNewPassword/{{$user}}">
              @csrf
              <div class="form-floating mb-3">
                <label for="floatingInputEmail">Nova senha</label>
                <input type="password" name="password" class="form-control" id="floatingInputEmail">
                @foreach ($errors->password as $error)
                    <li>{{ $error }}</li>
                @endforeach
              </div>
              <div class="form-floating mb-3">
                <label for="floatingInputEmail">Confirmar nova Senha</label>
                <input type="password" name="password_confirmation" class="form-control" id="floatingInputEmail">
