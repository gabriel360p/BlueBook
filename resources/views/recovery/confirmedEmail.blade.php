      ...
      <div class="col-lg-10 col-xl-9 mx-auto">
        <div class="card flex-row my-5 border-0 shadow rounded-3 overflow-hidden">
          ...
          <div class="card-body p-4 p-sm-5">
            ...
            <div class="card-subtitle">Caso esse email exista no sistema, será enviado um código de recuperação.</div>
              <hr>
            <form class="form-group" method="POST" action="/defConfirmedEmail/">
              @csrf
