	       ...
	       <div class="container">
			    <div class="row">
			        <div class="col-6 offset-3 text-center pt-4">
			            <h3 class="border-bottom border-dark p-2">Nova Tarefa</h3>                
			        </div>            
				</div>
			</div>
            ...
            <div class="card-body bg-light">
                <div class = "container">
        			<form id="contact-form" role="form" class="form-group" method="POST" action="/defNewTask/">
        				@csrf
                        <div class="controls">
                            <div class="row">
                                <label> Titulo </label>
                                ...
                                @enderror
                                <label> Tarefa </label>
                                <input type="text" class="form-control" required name="description" value="" placeholder="Subtitulo">
                                    @error('task')
                                        <li style="color:white;">{{$message}}</li>
                                    @enderror
                                <label>Descrição</label>
                                <textarea rows="3" class="form-control" required name="task" value="" placeholder="Descrição"></textarea>
                                    @error('description')
                                        <li style="color:white;">{{$message}}</li>
                                    @enderror
                                ...
                                <div class="container" style="margin-top:25px;">
                                    ...
                                    <input type="time" class="form-control" name="time" required value="">
                                </div>
